...
const answers = [
    ...
    '{userName}のいいところは厳しさはです。{userName}の厳しさがものごとをいつも成功に導きます。',
    '{userName}のいいところは知識です。博識な{userName}を多くの人が頼りにしています。',
    '{userName}のいいろころはユニークさです。{userName}だけのその特徴が皆をたのしくさせます。',
 ...
 * @return{string}userName診断結果
 */
function assessment(userName){
    //全文字のコード番号を取得してそれをたしあわせる
    let sumOfCharCode=0;
